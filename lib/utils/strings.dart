class AppStrings {
  ...
  static const String clearDataWarning = 'This will permanently delete all your stored credentials and family members. This action cannot be undone.';
  static const String importDataWarning = 'Importing data will replace all your current data. Are you sure you want to continue?';
  static const String backupCreated = 'Your backup has been created and can be imported on other devices where you have KeepSafe installed.';
  static const String backupCompatibilityIssue = 'The backup file could not be imported because it was created on a different device or with a different app version.';
  static const String recommendation = 'Recommendation:';
  static const String createNewBackup = '• Create a new backup on your original device using the latest app version';
  static const String manualRecreate = '• If that\'s not possible, you\'ll need to manually recreate your data on this device';
